...
local COMMENTARY_KEYWORDS = {"author", "audio description", "commentary", "description", "director",
                             "director's commentary", "коммент", "Коммент", "комментарии",
                             "Комментарии", "описание", "Описание", "режиссер",
                             "Режиссер"}

local FORCED_EXCLUDE_KEYWORDS = {"forc", "force", "forced", "hard", "hardsub", "hardcoded", "sign", "signs", -- "sdh",
"надписи", "Надписи", "принуд", "Принуд", "форс", "Форс"}

local RUSSIAN_FULL_KEYWORDS = {"complete", "full", "rus", "rus ass", "rus complete", "rus full", "rus pgs", "rus sdh",
                               "rus srt", "rus sub", "rus subs", "russian", "russian ass", "russian complete",
                               "russian full", "russian pgs", "russian sdh", "russian srt", "russian sub",
                               "russian subs", "russian subtitles", "rus subtitles", "russub", "полные",
                               "Полные", "полный", "Полный", "рус", "Рус",
                               "русские субтитры", "Русские субтитры",
                               "русский sdh", "Русский sdh", "русский суб",
                               "Русский суб", "русские полные", "Русские полные",
                               "руссуб", "Руссуб"}

local RUSSIAN_FORCED_KEYWORDS = {"forc", "force", "forced", "forced pgs", "forced rus", "forced russian",
                                 "forced subtitles rus", "hard", "hardsub", "hardcoded", "rus forced", "rus hardcoded",
                                 "rus signs", "russian forced", "russian hardcoded", "russian signs", "sign", "signs",
                                 "signs only", "forced rus sub", "russian signs only", "надписи",
                                 "Надписи", "надписи только", "Надписи только",
                                 "принуд", "Принуд", "русские надписи",
                                 "Русские надписи", "принудительные русские",
                                 "Принудительные русские", "русские принуд",
                                 "Русские принуд", "форс", "Форс"}
...
local function choose_best_audio_track()
    ...
    local priorities = ru_subs and {function(t)
        return is_original_audio(t) and not is_commentary(t) and not is_excluded_audio(t)
    end, function(t)
        local lang = (t.lang or ""):lower()
        return not (lang == "ru" or lang == "rus" or lang == "en" or lang == "eng") and not is_commentary(t) and
                   not is_excluded_audio(t)
    end, function(t)
